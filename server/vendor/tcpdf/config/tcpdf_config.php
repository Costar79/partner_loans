 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', '/home/costarne/public_html/t/img/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', '../../../img/CL_logo_200x51.png');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Co-Lend Finance');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Co-Lend Finance');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Co-Lend Finance');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Co-Lend Finance");
